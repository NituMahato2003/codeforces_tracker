...
// This component displays a list of Codeforces problems, and lets the user filter them by rating range and 
// tag.  It also shows whether a problem is already solved by the user or not.
